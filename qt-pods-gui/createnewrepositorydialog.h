...
namespace Ui {
class CreateNewRepositoryDialog;
}

class CreateNewRepositoryDialog : public QDialog {
    Q_OBJECT

public:
    explicit CreateNewRepositoryDialog(QWidget *parent = 0);
    ~CreateNewRepositoryDialog();

private:
    Ui::CreateNewRepositoryDialog *ui;
};
